...
dataset = mutate(d, weekday_registration = as.factor(format(dataset$appointment_registration,"%a")))
dataset = mutate(d, day_registration = as.numeric(as.integer(format(dataset$appointment_registration,"%d"))))
dataset = mutate(d, month_registration = as.numeric(format(dataset$appointment_registration,"%m")))
dataset = mutate(d, date_registration = as.numeric(format(dataset$appointment_registration,"%D")))
dataset = mutate(d, hour_registration = as.numeric(format(dataset$appointment_registration,"%H")))
dataset = mutate(d, minute_registration = as.numeric(format(dataset$appointment_registration,"%M")))
dataset = mutate(d, day_of_year_registration = as.numeric(format(dataset$appointment_registration,"%j")))
dataset = mutate(d, week_of_year_registration = as.numeric(format(dataset$appointment_registration,"%U")))
dataset = mutate(d, am_pm_registration = as.factor(format(dataset$appointment_registration,"%p")))

#Appt Actual Date
dataset$appointment_data = as.POSIXct(as.character(dataset$appointment_data),"%Y-%m-%d T%H:%M:%SZ",tz = "Brazil/East")

dataset = mutate(d, weekday_appointment = as.factor(format(dataset$appointment_data,"%a")))
dataset = mutate(d, day_appointment = as.numeric(as.integer(format(dataset$appointment_data,"%d"))))
dataset = mutate(d, month_appointment = as.numeric(format(dataset$appointment_data,"%m")))
dataset = mutate(d, date_appointment = as.numeric(format(dataset$appointment_data,"%D")))
dataset = mutate(d, day_of_year_appointment = as.numeric(format(dataset$appointment_data,"%j")))
dataset = mutate(d, week_of_year_appointment = as.numeric(format(dataset$appointment_data,"%U")))
```
