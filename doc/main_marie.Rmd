...
#Appt Actual Date
dataset$appointment_data <- as.POSIXct(as.character(dataset$appointment_date), 
                                       "%Y-%m-%d T%H:%M:%SZ", 
                                       tz = "Brazil/East")

dataset$weekday_appointment <- as.factor(format(dataset$appointment_data,"%a"))
dataset$day_appointment <- as.numeric(as.integer(format(dataset$appointment_data,"%d")))
dataset$month_appointment <- as.numeric(format(dataset$appointment_data,"%m"))
dataset$day_of_year_appointment <- as.numeric(format(dataset$appointment_data,"%j"))
dataset$week_of_year_appointment <- as.numeric(format(dataset$appointment_data,"%U"))
```
