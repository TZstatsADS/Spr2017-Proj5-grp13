...
save(dataset, file = "../output/renamed_dataset.RData")
```

```{r}
## Add features for weather

# import data set (scrapped using BeautifulSoup)
weather <- read.csv("../output/selectedweather.csv")
```
